...
object Secp256r1 : EcCurve() {
    override val a: BigInteger =
        BigInteger.parseString("ffffffff00000001000000000000000000000000fffffffffffffffffffffffc", 16)
    override val b: BigInteger =
        BigInteger.parseString("5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b", 16)
    override val n: BigInteger =
        BigInteger.parseString("ffffffff00000000ffffffffffffffffbce6faada7179e84f3b9cac2fc632551", 16)
    override val p: BigInteger =
        BigInteger.parseString("ffffffff00000001000000000000000000000000ffffffffffffffffffffffff", 16)
